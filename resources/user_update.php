...
function updateUser($mysql, $arr)
{
    ...
    $sql="Update `bdm246823269_db`.`hb_user` SET `username` ='$username' ,`password` ='$password' ,`user_Manager` ='$user_Manager' ,`vip_baseinfo_create` ='$vip_baseinfo_create' ,`vip_baseinfo_read` ='$vip_baseinfo_read' ,`vip_baseinfo_update` ='$vip_baseinfo_update' ,`vip_baseinfo_delete` ='$vip_baseinfo_delete' ,`vip_ZhuYuanJiLu_create` ='$vip_ZhuYuanJiLu_create' ,`vip_ZhuYuanJiLu_read` ='$vip_ZhuYuanJiLu_read' ,`vip_ZhuYuanJiLu_update` ='$vip_ZhuYuanJiLu_update' ,`vip_ZhuYuanJiLu_delete` ='$vip_ZhuYuanJiLu_delete' ,`vip_ZengSongBaoXian_create` ='$vip_ZengSongBaoXian_create' ,`vip_ZengSongBaoXian_read` ='$vip_ZengSongBaoXian_read' ,`vip_ZengSongBaoXian_update` ='$vip_ZengSongBaoXian_update' ,`vip_ZengSongBaoXian_delete` ='$vip_ZengSongBaoXian_delete' ,`vip_TiJianBaoGao_create` ='$vip_TiJianBaoGao_create' ,`vip_TiJianBaoGao_read` ='$vip_TiJianBaoGao_read' ,`vip_TiJianBaoGao_update` ='$vip_TiJianBaoGao_update' ,`vip_TiJianBaoGao_delete` ='$vip_TiJianBaoGao_delete' ,`vip_QiTaShiXiang_create` ='$vip_QiTaShiXiang_create' ,`vip_QiTaShiXiang_read` ='$vip_QiTaShiXiang_read' ,`vip_QiTaShiXiang_update` ='$vip_QiTaShiXiang_update' ,`vip_QiTaShiXiang_delete` ='$vip_QiTaShiXiang_delete' ,`vip_JiaoFeiJiLu_create` ='$vip_JiaoFeiJiLu_create' ,`vip_JiaoFeiJiLu_read` ='$vip_JiaoFeiJiLu_read' ,`vip_JiaoFeiJiLu_update` ='$vip_JiaoFeiJiLu_update' ,`vip_JiaoFeiJiLu_delete` ='$vip_JiaoFeiJiLu_delete' ,`vip_BaoXiaoJiLu_create` ='$vip_BaoXiaoJiLu_create' ,`vip_BaoXiaoJiLu_read` ='$vip_BaoXiaoJiLu_read' ,`vip_BaoXiaoJiLu_update` ='$vip_BaoXiaoJiLu_update' ,`vip_BaoXiaoJiLu_delete` ='$vip_BaoXiaoJiLu_delete'  WHERE id ='$id' ";
